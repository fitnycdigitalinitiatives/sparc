...
//Returns 5 predominant colors from an image//
...
//16 basic color families for primary color//
...
//Returns color bar to search color families//
...
//Returns Color Name from Hex code//
...
//Returns Drop-down menu with color board//
