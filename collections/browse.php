	...
	*/ ?>
	...
	<div class="row" id="grid">
      ...
      <?php if ($item = get_record('Item', array('collection' => metadata($collection, 'id')))): ?>
        ...
        <span class="glyphicon glyphicon-info-sign" aria-hidden="true" data-toggle="popover" data-content="<?php echo metadata($collection, array('Dublin Core', 'Description')); ?>"></span>
