...
<div class="browse-collections">
	...
	*/ ?>
	...
	<div class="row" id="grid">
      ...
      <?php echo link_to_items_browse(mdid_thumbnail_tag($item, 'img-responsive') . '<div class="caption"><h5></h5></div>', array('collection' => metadata($collection, 'id')), array('class' => 'thumbnail')); ?>
